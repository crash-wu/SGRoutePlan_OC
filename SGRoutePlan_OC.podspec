...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SGRoutePlan_OC.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SGRoutePlan_OC'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '吴小星' => 'xiaoxing.wu@southgis.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SGRoutePlan_OC.git', :tag => s.version.to_s }
